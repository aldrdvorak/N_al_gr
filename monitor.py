...
class ConvertEvent(FileSystemEventHandler):
    def on_modified(self, event):
        ...
        test = np.loadtxt('N_al_gr_data/outputs/test.txt')
        output = np.loadtxt('N_al_gr_data/outputs/output.txt')
        ...
        test.save('N_al_gr_data/outputs/test.png')
        output.save('N_al_gr_data/outputs/output.png')

if __name__ == "__main__":
    path = 'N_al_gr_data/outputs/'
